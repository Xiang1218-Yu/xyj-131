...
import { Coins, Globe, Calendar, DollarSign, Heart, Search, Menu, X, Brain, Clock, Shield, Gift, Palette, TrendingUp, BookOpen, Tag } from 'lucide-react';
